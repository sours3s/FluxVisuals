...
public final class FogBlurPass {
   ...
   private final ShaderProgram program = ShaderProgram.fromResources(
      "assets/fluxvisuals/shaders/blur/blur_fullscreen.vert", "assets/fluxvisuals/shaders/postfx/fog_blur.frag"
   );
   private final ShaderProgram copyProgram = ShaderProgram.fromResources(
      "assets/fluxvisuals/shaders/blur/blur_fullscreen.vert", "assets/fluxvisuals/shaders/postfx/fog_copy.frag"
   );
