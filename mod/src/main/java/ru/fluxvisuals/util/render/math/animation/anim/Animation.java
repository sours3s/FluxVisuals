package ru.fluxvisuals.util.render.math.animation.anim;

import net.fabricmc.api.EnvType;
import net.fabricmc.api.Environment;
import ru.fluxvisuals.util.render.math.animation.anim.bezier.Bezier;
import ru.fluxvisuals.util.render.math.animation.anim.bezier.list.CubicBezier;
import ru.fluxvisuals.util.render.math.animation.anim.util.Easing;
