...
public final class TextCache {
   ...
   private static String key(FontObject font, String text, float size) {
    ...
    public static TextRenderer.TextMetrics measure(DrawGuiRenderer renderer, FontObject font, String text, float size) {
       String k = key(font, text, size);
       TextRenderer.TextMetrics hit = CACHE.get(k);
       if (hit != null) {
          return hit;
    ...
    public static float width(DrawGuiRenderer renderer, FontObject font, String text, float size) {
       return measure(renderer, font, text, size).width;
    }
