package ru.fluxvisuals.ui.gui.widget.bind;
...
import ru.fluxvisuals.event.input.MouseUpdateEvent;
...
import ru.fluxvisuals.module.bind.BindingMode;
import ru.fluxvisuals.module.impl.visuals.MenuSettingsModule;
import ru.fluxvisuals.ui.gui.widget.bind.editor.BindPopupComboEditor;
import ru.fluxvisuals.ui.gui.widget.bind.editor.BindPopupSelectableEditor;
import ru.fluxvisuals.ui.gui.widget.bind.editor.BindPopupSettingEditor;
import ru.fluxvisuals.ui.gui.widget.bind.editor.BindPopupSliderEditor;
import ru.fluxvisuals.ui.gui.widget.bind.editor.BindPopupSwitchEditor;
import ru.fluxvisuals.ui.gui.widget.popup.PopupPositioner;
import ru.fluxvisuals.ui.gui.widget.settings.HSBColor;
...
public final class BindPopupController {
   ...
   public synchronized boolean handleMouseClick(double mouseX, double mouseY, int button) {
      if (!this.isInteractable()) {
         ...
         if (button >= 0) {
            this.model.setKeyCode(KeyUtil.mouseButtonToKey(button));
            this.conflictActive = false;
            this.conflictTimestamp = 0L;
            this.stopListening();
            this.apply();
   ...
   private static int resolveMenuActivationKey() {
      ...
      if (module == null) {
         ...
         return module.bind != -1 ? module.bind : 344;
      }
   }
